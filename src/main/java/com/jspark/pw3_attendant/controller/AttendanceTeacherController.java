...
public class AttendanceTeacherController {
    ...
    public ResponseEntity<List<AttendanceTeacher>> getAllTeachersAttendance(@RequestParam LocalDate date) {
        List<AttendanceTeacher> attendanceList = attendanceTeacherService.getAllTeachersAttendanceByDate(date);
